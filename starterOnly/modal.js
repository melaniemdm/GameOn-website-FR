...
spanCloseFins.forEach((spanCloseFin) =>
  spanCloseFin.addEventListener("click", closeModalFin)
);
...
inputVilles.forEach((inputVille) =>
  inputVille.addEventListener("change", testVilles)
);
...
function launchModal() {
  ...
  if (sessionStorage.getItem("donneesSauvees")) {
    ...
    document.querySelector("#location1").checked ===
      sessionStorage.getItem("saisieVille1");
    document.querySelector("#location2").checked ===
      sessionStorage.getItem("saisieVille2");
    document.querySelector("#location3").checked ===
      sessionStorage.getItem("saisieVille3");
    document.querySelector("#location4").checked ===
      sessionStorage.getItem("saisieVille4");
    document.querySelector("#location5").checked ===
      sessionStorage.getItem("saisieVille5");
    document.querySelector("#location6").checked ===
      sessionStorage.getItem("saisieVille6");
...
function launchModalFin() {
  ...
  let userMessage =
    ...
    "/" +
    sessionStorage.getItem("saisieBirthdate") +
    "/" +
    sessionStorage.getItem("saisieConcours") +
    "/" +
    sessionStorage.getItem("saisieVille1") +
    "/" +
    sessionStorage.getItem("saisieVille2") +
    ...
    sessionStorage.getItem("saisieVille6") +
    "/" +
    sessionStorage.getItem("checkConditions") +
    "/" +
    sessionStorage.getItem("checkConditions2");
